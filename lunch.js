...
const whatToDoForLunch = function(hungry, availableTime) {
  ...
  if (hungry !== true && availableTime > 0) {
    return("I go back to work");
  } else if (hungry = true && availableTime < 20 ) {
  return ("Pick something up and eat in the lab")
  } else if (hungry = true && 20 <= availableTime && availableTime <= 30 ) {
  return ("Try a new place nearby")
  } else if (hungry = true && availableTime > 30 ) {
  return ("Remind ourselves we're in a bootcamp and we dont have much time to spare")
  }
}
